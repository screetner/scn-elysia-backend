...
// AssetType Table
export const assetTypeTable = pgTable(
  'assetTypes',
  {
...
export const assetTable = pgTable(
  'assets',
  {
    ...
    assetTypeId: text('assetTypeId').references(
      () => assetTypeTable.assetTypeId,
    ),
...
export const roleTable = pgTable(
  ...
  table => ({
    ...
    organizationIdIdx: index('role_organizationId_idx').on(
...
// VideoSession Table
export const videoSessionStateEnum = pgEnum('video_session_state', [
  'uploading',
  'uploaded',
  'processing',
  'processed',
...
export const videoSessionTable = pgTable('videoSessions', {
  ...
  uploadUserId: text('uploadUserId')
...
export const inviteTable = pgTable(
  ...
  table => ({
    ...
    organizationIdIdx: index('invite_organizationId_idx').on(
      table.organizationId,
    ),
